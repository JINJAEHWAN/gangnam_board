...
<body>
    <div class="content">
        ...
        <form action="${pageContext.request.contextPath}/writeAction.co" method="post">
            <div class="title">
        ...
        document.getElementById('travelBudget').addEventListener('change', function() {
            ...
            if (selectedValue) {
                const budgetRanges = {
                    ...
                    '3000000': '200만원 ~ 300만원',
                    '5000000': '300만원 ~ 500만원',
                    '10000000': '500만원 ~ 1000만원',
                    '20000000': '1000만원 ~ 2000만원',
                    '30000000': '2000만원 ~ 3000만원',
                    '50000000': '3000만원 ~ 5000만원',
                    '100000000': '5000만원 이상'
                };
                
                budgetDisplay.textContent = `선택한 예산: ${budgetRanges[selectedValue]}`;
